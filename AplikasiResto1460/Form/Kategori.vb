Public Class Kategori
    ...
    Private Sub btnHapus_Click(sender As Object, e As EventArgs) Handles btnHapus.Click
        ...
        If MsgBox("Apakah anda yakin akan menghapus " & txtIDKategori.Text & "-" & txtNama.Text & "?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Konfirmasi") = MsgBoxResult.Yes Then
            KontrolKategori.deleteData(txtIDKategori.Text)
        End If
        RefreshGrid()
    End Sub

    Private Sub txtIDKategori_TextChanged(sender As Object, e As EventArgs) Handles txtIDKategori.TextChanged
